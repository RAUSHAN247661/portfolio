...
const Projects = ({ data }) => {
  return (
    <div id='projects' className="max-w-106 rounded-lg outline-[#FFFFFF] hover:shadow-2xl duration-300 transition-all shadow-gray-300 border border-gray-200">
  <img src={data?.image} alt={`${data?.title} image`} loading="lazy" decoding="async" />
